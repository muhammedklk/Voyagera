...
const TESTIMONIALS = [
  {
    id: 1,
    quote:
      'Our five days at Arashiyama Bamboo Villa felt like floating through a dream. The private natural geothermal onsen and morning tea ceremony restored a quietude we had forgotten.',
  ...
  },
  {
    id: 2,
    quote:
      'The Engadin Alpine Lodge in St. Moritz was completely unmatched. Stargazing through the telescope deck with sub-zero air and heated thermal baths was absolute bliss.',
    author: 'Dr. Julian Thorne',
    role: 'Astrophysicist & Author',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop',
    location: 'Engadin Alps, Switzerland',
    rating: 5,
    year: 'Winter 2025',
  },
  {
    id: 3,
    quote:
      'Staying at Ravello Cliffside Residence overlooking Positano gave us a deep appreciation of Mediterranean architecture and quiet luxury. Nattuvazhi is in a class of its own.',
    author: 'Sophia & Alexander Chen',
    role: 'Art Historians & Writers',
